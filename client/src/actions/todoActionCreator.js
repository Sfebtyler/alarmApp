	...
	createTodo: function (todo) {
		...
		newTodoPromise
			...
			.fail(function (xhr, status, err) {
				...
				toastr.error("Create Todo Failed!");
			});
	},

	deleteTodo: function (todo) {
		var prompt = window.confirm("Do you want to Delete this Todo?")
		...
		deleteTodoPromise
			...
			.fail(function (xhr, status, err) {
				...
				toastr.error("Delete Todo Failed!");
			});
	},
	...
	updateTodo: function (todo) {
		...
		updateTodoPromise
			...
			.fail(function (xhr, status, err) {
				...
				toastr.error("Update Todo Failed!");
			});
	}
};
